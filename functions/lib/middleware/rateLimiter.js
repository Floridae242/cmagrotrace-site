...
exports.isRateLimited = exports.applyRateLimit = exports.rateLimiter = void 0;
...
exports.rateLimiter = (0, express_rate_limit_1.default)(rateLimitConfig);
// Helper function to wrap rate limiter for Firebase Functions
const applyRateLimit = (handler) => {
    return functions.https.onRequest((req, res) => {
        // Apply rate limiting
        (0, exports.rateLimiter)(req, res, () => {
